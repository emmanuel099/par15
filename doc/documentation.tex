...
\caption{Scalability}
\begin{tabular}{cc}
\subcaptionbox{Jupiter: MPI (Nonblocking) with 10 Iterations\label{jupiter:mpi:scalability:nonblocking:10}}{\includegraphics[width=0.5\textwidth]{jupiter_scale.pdf}}
\end{tabular}
\end{figure}
